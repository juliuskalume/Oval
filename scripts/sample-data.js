...
export const DEMO_COMMENTS = {
  "demo-frontend-intern": [
    {
      id: "demo-frontend-comment-1",
      authorUid: "demo-user-selin",
      authorName: "Selin Kaya",
      authorHandle: "@selin.dev",
      authorPhotoURL: "https://i.pravatar.cc/100?img=1",
      body: "Is this role open to fresh graduates, or are you expecting prior internship experience?",
      parentId: null,
      createdAt: "2026-04-04T09:20:00.000Z",
      updatedAt: "2026-04-04T09:20:00.000Z",
    },
    {
      id: "demo-frontend-comment-2",
      authorUid: "demo-user-remotefirst",
      authorName: "RemoteFirst HQ",
      authorHandle: "@remotefirsthq",
      authorPhotoURL: "https://images.unsplash.com/photo-1542744173-8e7e53415bb0?auto=format&fit=crop&w=300&q=80",
      body: "Fresh graduates can apply. A small portfolio and comfort with modern frontend tooling matter more than formal work history.",
      parentId: "demo-frontend-comment-1",
      createdAt: "2026-04-04T09:42:00.000Z",
      updatedAt: "2026-04-04T09:42:00.000Z",
    },
    {
      id: "demo-frontend-comment-3",
      authorUid: "demo-user-mert",
      authorName: "Mert Yildiz",
      authorHandle: "@mert.codes",
      authorPhotoURL: "https://i.pravatar.cc/100?img=5",
      body: "Do applicants need React specifically, or would strong JavaScript plus a few shipped side projects be enough?",
      parentId: null,
      createdAt: "2026-04-04T10:05:00.000Z",
      updatedAt: "2026-04-04T10:05:00.000Z",
    },
    {
      id: "demo-frontend-comment-4",
      authorUid: "demo-user-careercoach",
      authorName: "Nora James",
      authorHandle: "@careercoachnora",
      authorPhotoURL: "https://i.pravatar.cc/100?img=9",
      body: "This is a strong junior opening. Salary transparency and a clear portfolio ask are both good signs.",
      parentId: null,
      createdAt: "2026-04-04T10:44:00.000Z",
      updatedAt: "2026-04-04T10:44:00.000Z",
    },
  ],
  "demo-women-stem-scholarship": [
    {
      id: "demo-stem-comment-1",
      authorUid: "demo-user-amina",
      authorName: "Amina Yusuf",
      authorHandle: "@aminastudies",
      authorPhotoURL: "https://i.pravatar.cc/100?img=20",
      body: "Can final-year students apply if they have not graduated yet?",
      parentId: null,
      createdAt: "2026-04-04T08:40:00.000Z",
      updatedAt: "2026-04-04T08:40:00.000Z",
    },
    {
      id: "demo-stem-comment-2",
      authorUid: "demo-user-futurelabs",
      authorName: "FutureLabs",
      authorHandle: "@futurelabs",
      authorPhotoURL: "https://images.unsplash.com/photo-1516321318423-f06f85e504b3?auto=format&fit=crop&w=300&q=80",
      body: "Yes. As long as you are still enrolled when you apply, you are eligible for this cycle.",
      parentId: "demo-stem-comment-1",
      createdAt: "2026-04-04T09:03:00.000Z",
      updatedAt: "2026-04-04T09:03:00.000Z",
    },
  ],
  "demo-ui-audit-gig": [
    {
      id: "demo-ui-comment-1",
      authorUid: "demo-user-lina",
      authorName: "Lina Otto",
      authorHandle: "@linaux",
      authorPhotoURL: "https://i.pravatar.cc/100?img=32",
      body: "Would you accept a Figma + Loom walkthrough, or do you need a written PDF deliverable only?",
      parentId: null,
      createdAt: "2026-04-04T07:55:00.000Z",
      updatedAt: "2026-04-04T07:55:00.000Z",
    },
  ],
  "demo-junior-product-designer": [
    {
      id: "demo-product-comment-1",
      authorUid: "demo-user-ella",
      authorName: "Ella M",
      authorHandle: "@ella.designs",
      authorPhotoURL: "https://i.pravatar.cc/100?img=47",
      body: "Is the hybrid requirement strict, or can someone join remotely if they overlap with the team timezone?",
      parentId: null,
      createdAt: "2026-04-04T06:48:00.000Z",
      updatedAt: "2026-04-04T06:48:00.000Z",
    },
  ],
};
